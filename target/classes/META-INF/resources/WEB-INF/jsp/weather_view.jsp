...
<html>
  ...
  <body>
    ...
    <div id="weather_search" class="card-body" align="center">
      ...
      <div class="col-5">
        <form action="" method="get">
          ...
          <button
            type="submit"
            formaction="/current/weather"
            name="current"
            class="btn btn-success btn-sm"
          >
            Find out the current weather!
          </button>
          <button
            type="submit"
            formaction="/five_day/weather"
            name="five_day"
            class="btn btn-info btn-sm"
          >
            Find out 5 day forecast!
          </button>
        </form>
      </div>
    </div>
    ...
    <div id="iso_codes" class="card-body" align="center">
      ...
      <p>
        To search for your country, hold 'Ctrl' and press 'F' and then enter
        your country
      </p>
